    ...
    <div>
      <blockquote 
        ...
        <div style={{ padding: '16px' }}>
          <a href="https://www.instagram.com/reel/DAD4bdMylqU/?utm_source=ig_embed&amp;utm_campaign=loading" 
            ...
            <div style={{ display: 'block', height: '50px', margin: '0 auto 12px', width: '50px' }}>
              {/* Insert Instagram Reel SVG or other content here */}
            </div>
          ...
          <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            <a href="https://www.instagram.com/reel/DAD4bdMylqU/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', textDecoration: 'none' }} target="_blank" rel="noopener noreferrer">

      ...
      <div className="flex flex-col md:flex-row gap-12 items-start">
        <div className="space-y-8 md:w-1/2">
          ...
          <p className="text-lg sm:text-xl text-gray-600 mb-6">
            ...
            you with the latest trends and techniques. With skilled educators and hands-on experience, we&apos;re
            dedicated to helping you discover your potential and start a successful career in beauty.
          </p>
          <p className="text-lg sm:text-xl text-gray-600">
            Our salon has earned numerous accolades, collaborating with celebrity hairstylists like Ritika Kadam and
            Ojas Rajani, and receiving guidance from Parul Garg. We&apos;ve styled celebrities such as Mahi Vij and
            Sonam Kapoor, along with many influencers. Honored as the Best Bridal Makeup Artist in Delhi in 2018 and
            consistently ranked as the top bridal artist on WedMeGood since 2021, our reputation in the industry is
            well-established.
          </p>
        </div>
        <div className="w-full md:w-1/2 mt-8 md:mt-0">
          <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] mx-auto max-w-[500px]">
            <Image
              src={sonam || "/placeholder.svg"}

...
export const About = () => {
    return (
        <div className="min-h-[100vh] bg-[#fee6e1] pt-5 w-[100%] flex flex-col items-center  gap-9 justify-center">
            <div className="flex md:flex-row flex-col gap-9 w-[80%] items-stretch mt-9 py-9 justify-center">

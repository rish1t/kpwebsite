...
export default function Hero() {
  ...
  return (
    <div className="relative w-full z-0 md:h-screen h-[60vh] overflow-hidden poppins">
      ...
      <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center">
        <div className="text-center text-white px-4 flex flex-col items-center justify-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold mb-4 drop-shadow-lg">
            Kaya Planet.
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto drop-shadow-md">
              Where beauty meets relaxation
          </p>
          <button className="bg-white flex gap-3 self-center text-black px-8 py-3 rounded-full font-medium text-lg hover:bg-opacity-90 transition-colors shadow-lg">
